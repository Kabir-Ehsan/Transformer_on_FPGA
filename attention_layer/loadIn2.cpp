...
void loadIn(fp1 *x1, fp1 *x2, fp1 *x3, fp1 *x4, fp1 *x5, fp1 *x6, fp2 *in_stream, int *index, int seq_out, int tile, int factor) // fp1 *x5, fp1 *x6, fp1 *x7, fp1 *x8, *x11, fp1 *x12,
{
	inputs1:for(int i=0;i<BATCH_SIZE*SEQ_LEN*TILE_SIZE;i++)
	{
		if(i<factor)
...
*/
/*
void loadIn(fp1 *x1, fp1 *x2, fp1 *x3, fp1 *x4, fp2 *in_stream, int *index, int seq_out, int tile, int factor) // fp1 *x5, fp1 *x6, fp1 *x7, fp1 *x8, *x11, fp1 *x12,
{
	inputs1:for(int i=0;i<BATCH_SIZE*SEQ_LEN*TILE_SIZE;i++)
	{
		if(i<factor)
...
void loadIn(fp1 *x1, fp1 *x2, fp1 *x3, fp1 *x4, fp1 *x5, fp1 *x6, fp1 *x7, fp1 *x8, fp2 *in_stream, int *index, int seq_out, int tile, int factor) // fp1 *x5, fp1 *x6, fp1 *x7, fp1 *x8, *x11, fp1 *x12,
{
	inputs1:for(int i=0;i<BATCH_SIZE*SEQ_LEN*TILE_SIZE;i++)
	{
		if(i<factor)
...
/*
void loadIn(fp1 *x1, fp1 *x2, fp1 *x3, fp2 *in_stream, int *index, int seq_out, int tile, int factor) // fp1 *x5, fp1 *x6, fp1 *x7, fp1 *x8, *x11, fp1 *x12,
{
	inputs1:for(int i=0;i<BATCH_SIZE*SEQ_LEN*TILE_SIZE;i++)
	{
		if(i<factor)
