...
#include "TNN_5.h"
/*
void loadWo(fp2 (*wo1)[fact1], fp2 *weight_stream1, int *index, int embed_out, int nheads_out, int factor)
{
	weightO1:for(int i=0;i<fact1;i++)
	{
		if(i<factor)//(embed_out/nheads_out))
		{
			weightO2:for(int j=0;j<fact1;j++)
			{
